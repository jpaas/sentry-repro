        ...
        >
          ...
          <View style={styles.section}>
            <View style={[styles.shadowBox]}>
              ...
              >
                <Svg fill="none" height={24} stroke="#000000" viewBox="0 0 24 24" width={24}>
                  <Path
                ...
                <Svg fill="none" height={18} stroke="#000000" viewBox="0 0 24 24" width={18}>
                  <Path
                    d="M9 5l7 7-7 7"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <View style={styles.section}>
            ...
            >
              <View style={[styles.listItem, styles.shadowBox]}>
                <Svg fill="rgba(0, 122, 204, 1)" height={48} viewBox="0 0 24 24" width={48}>
            ...
            >
              <View style={styles.shadowBox}>
                <View style={[styles.listItem, styles.marginBottomMd]}>
                  <Svg fill="none" height={48} viewBox="0 0 120 120" width={48}>
                    <Path
